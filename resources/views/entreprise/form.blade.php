                        ...
                        <div class="card-body">
                            ...
                            <select id="category_id" name="category_id" class="custom-select custom-select-md mb-3">
                                ...
                                @foreach($categories as $category)
                                    <option
                                            value=" {{ $category->id }}"
                                            @if(old('category_id', isset($product) ? $product->category_id : '') == $category->id) selected @endif>{{ $category->name }}
                                    </option>
                            ...
                            <x-textareabs4
                                    ...
                                    :value="isset($product) ? $product->sousdescription : ''"
                            ></x-textareabs4>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="active" name="active"
                                           @if(old('active', isset($product) ? $product->active : false)) checked @endif>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6">
                                    <a class="btn hor-grd btn-grd-warning btn-block"
                                       href="{{ route('produits.index') }}" role="button">
                                        <i class="fas fa-arrow-left"></i> Retour à la liste des produits
                                    </a>
                                </div>
                                <div class="col-md-6">
                                    <button type="submit" class="btn hor-grd btn-grd-success btn-block">Enregistrer</button>
                                </div>
                            </div>
